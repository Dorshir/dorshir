 ...
 *				that returns positive if x < y 
 *				or 0 if x == y or negative otherwise.
 ...
 * @return iterator pointing to the item added or iterator to end on failure or null if tree is null pointer
 ...
 * @returns an iterator pointing at the next element after _it or end iterator or null if _it is null.
 */
